...
// Place function or variable to section
#define GCC_SECTION(section_name)   __attribute__((section(#section_name)))
...
#define GCC_OPTIMIZE_NONE           __attribute__((optimize("O0")))
#define GCC_OPTIMIZE_LEVEL1         __attribute__((optimize("O1")))
#define GCC_OPTIMIZE_LEVEL2         __attribute__((optimize("O2")))
#define GCC_OPTIMIZE_LEVEL3         __attribute__((optimize("O3")))
#define GCC_OPTIMIZE_SIZE           __attribute__((optimize("Os")))
#define GCC_OPTIMIZE_SPEED          __attribute__((optimize("Ofast")))
#define GCC_OPTIMIZE_DEBUG          __attribute__((optimize("Og")))
